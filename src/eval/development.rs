...
pub const WHITE_ROOK_STARTING_POSITIONS: u64 = 0x81;
pub const WHITE_KNIGHT_STARTING_POSITIONS: u64 = 0x42;
pub const WHITE_BISHOP_STARTING_POSITIONS: u64 = 0x24;
pub const WHITE_QUEEN_STARTING_POSITION: u64 = 0x8;
pub const BLACK_ROOK_STARTING_POSITIONS: u64 = 0x8100000000000000;
pub const BLACK_KNIGHT_STARTING_POSITIONS: u64 = 0x4200000000000000;
pub const BLACK_BISHOP_STARTING_POSITIONS: u64 = 0x2400000000000000;
pub const BLACK_QUEEN_STARTING_POSITION: u64 = 0x800000000000000;

// Each array item represents 3 full moves (both sides go) of the game.
pub const UNDEVELOPED_ROOK_PENALTY: [i32; 10] = [0, 0, 0, 0, 16, 32, 48, 48, 64, 64];
pub const UNDEVELOPED_KNIGHT_PENALTY: [i32; 10] = [0, 16, 16, 32, 32, 64, 64, 64, 64, 64];
pub const UNDEVELOPED_BISHOP_PENALTY: [i32; 10] = [0, 0, 16, 16, 32, 32, 64, 64, 64, 64];
pub const UNDEVELOPED_QUEEN_PENALTY: [i32; 10] = [-64, -32, -16, 0, 0, 16, 16, 32, 32, 64]; // Negative values to punish early development
